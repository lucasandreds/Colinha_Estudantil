...
// 🔽 Adicionando session e connect-sqlite3
import session from "express-session";
import SQLiteStore from "connect-sqlite3";  // Agora usamos o connect-sqlite3
...
app.use(
  session({
    store: new SQLiteStore({ db: "sessions.sqlite", dir: "./" }),  // Agora usando connect-sqlite3
...
// Configuração do servidor e outros middlewares

...
// Instanciando o SQLiteStore passando a instância do session
const store = new SQLiteStore({
  db: "sessions.sqlite", // Nome do banco de dados de sessões
  dir: "./db",           // Diretório onde o banco de dados será armazenado
  table: "sessions",     // Nome da tabela onde as sessões serão salvas
});
